# Generated by Django 5.2.5 on 2025-11-27 15:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.ForeignKey(help_text="Name of the stable (e.g., 'Miyagino')", on_delete=django.db.models.deletion.PROTECT, related_name='heya_name', to='game.shikona', verbose_name='Name')),
            ],
            options={
                'verbose_name': 'Heya',
